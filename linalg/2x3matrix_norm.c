/**
 * File:          $RCSfile: 2x3matrix_norm.c,v $
...
/**
 * \fn Gan_Bool gan_mat23_normalize ( Gan_Matrix23 *B, int n, double term_threshold, int max_iterations, Gan_SquMatrix33 *Lp )
 * \brief Normalize array of 2x3 matrices to identity inertia moment.
 ...
 *
 * This function applies projective normalization to the array of \a n 2x3
