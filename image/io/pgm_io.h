...
GANDALF_API Gan_Image *gan_read_pgm_image(const Gan_UnicodeChar *filename, Gan_Image *image,
                                          const struct Gan_ImageReadControlStruct *ictrlstr, struct Gan_ImageHeaderStruct *header,
                                          Gan_Bool (*abortRequested)(void*), void* abortObj);
...
GANDALF_API Gan_Bool   gan_write_pgm_image ( const Gan_UnicodeChar *filename, const Gan_Image *image, const struct Gan_ImageWriteControlStruct *octrlstr );
