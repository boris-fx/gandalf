/**
 * File:          $RCSfile: image_rgbas_uint10.c,v $
 * Module:        RGBA colour images with small alpha channel
...
#define GAN_PIXEL_FORMAT RGBA colour with small alpha channel
#define GAN_PIXEL_TYPE gan_uint16
#define GAN_PIXFMT GAN_RGBAS
#define GAN_PIXTYPE GAN_UINT10
#define GAN_IMFMT rgbas
