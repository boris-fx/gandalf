...
Gan_ImageWindow gan_image_union_subwindows_s ( const Gan_ImageWindow *window1, const Gan_ImageWindow *window2 )
{
   ...
   iwResult.c0 = gan_min2_ui(window1->c0, window2->c0);
   iwResult.r0 = gan_min2_ui(window1->r0, window2->r0);
   iwResult.width  = gan_max2_ui(window1->c0+window1->width,  window2->c0+window2->width)  - iwResult.c0;
   iwResult.height = gan_max2_ui(window1->r0+window1->height, window2->r0+window2->height) - iwResult.r0;
   return iwResult;
}
