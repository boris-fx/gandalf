 ...
 * Last edited:   $Date: 2007/06/06 16:03:59 $
 * Author:        $Author: pm $
...
/**
 * \brief Structure defining BGR colour unsigned long integer pixel.
 */
typedef struct Gan_BGRPixel_ul
{
   unsigned long R, /**< Red channel */
                 G, /**< Green channel */
                 B; /**< Blue channel */
...
/**
 * \brief Structure defining BGR colour single precision floating point pixel.
 */
 ...
 * \brief Structure defining BGR colour signed integer pixel.
 */
typedef struct Gan_BGRAPixel_l
{
   long R, /**< Red channel */
        G, /**< Green channel */
        B, /**< Blue channel */
...
/**
 * \brief Structure defining BGR unsigned long integer pixel with alpha channel.
 */
typedef struct Gan_BGRAPixel_ul
{
   unsigned long R, /**< Red channel */
                 G, /**< Green channel */
                 B, /**< Blue channel */
...
/**
 * \brief Structure defining YUV 16-bit 4-4-4 pixel padded to a word boundary
 */
typedef struct Gan_YUVX444Pixel_ui16
{
   gan_uint16 Y; /**< Luminance channel */
   gan_uint16 U; /**< Chrominance channel */
   gan_uint16 V; /**< Chrominance channel */
   gan_uint16 X; /**< padding */
} Gan_YUVX444Pixel_ui16;
...
/**
 * \brief Structure defining YUVA 16-bit 4-4-4 pixel
 */
typedef struct Gan_YUVA444Pixel_ui16
{
   gan_uint16 Y; /**< Luminance channel */
   gan_uint16 U; /**< Chrominance channel */
   gan_uint16 V; /**< Chrominance channel */
   gan_uint16 A; /**< alpha channel */
} Gan_YUVA444Pixel_ui16;
...
/**
 * \brief Structure defining UYVY 16-bit 4-2-2 pixel
 *
 * NB cannot be used to iterate along raster because of the 4-2-2 sampling
 */
typedef struct Gan_YUV422Pixel_ui16
{
   gan_uint16 UV; /**< One of the two chrominance channels, depending on the column position */
   gan_uint16 Y;  /**< Luminance channel */
} Gan_YUV422Pixel_ui16;
...
/**
 * \brief Structure defining BGR colour 64-bit unsigned integer pixel.
 */
typedef struct Gan_BGRPixel_ui Gan_BGRPixel_ui64;

/**
 * \brief Structure defining BGR colour 64-bit signed integer pixel.
 */
typedef struct Gan_BGRPixel_i Gan_BGRPixel_i64;

/**
 * \brief Structure defining BGR colour 64-bit unsigned integer pixel with alpha channel.
 */
typedef struct Gan_BGRAPixel_ui Gan_BGRAPixel_ui64;

/**
 * \brief Structure defining BGR colour 64-bit signed integer pixel  with alpha channel.
 */
typedef struct Gan_BGRAPixel_i Gan_BGRAPixel_i64;
 ...
 * \brief Structure defining BGR colour 64-bit unsigned integer pixel.
 */
typedef struct Gan_BGRPixel_ul Gan_BGRPixel_ui64;

/**
 * \brief Structure defining BGR colour 64-bit signed integer pixel.
 */
typedef struct Gan_BGRPixel_l Gan_BGRPixel_i64;

/**
 * \brief Structure defining BGR colour 64-bit unsigned integer pixel with alpha channel.
 */
typedef struct Gan_BGRAPixel_ul Gan_BGRAPixel_ui64;

/**
 * \brief Structure defining BGR colour 64-bit signed integer pixel  with alpha channel.
 */
typedef struct Gan_BGRAPixel_l Gan_BGRAPixel_i64;
