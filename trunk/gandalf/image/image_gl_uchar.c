/**
 * File:          $RCSfile: image_gl_uchar.c,v $
 * Module:        Grey level unsigned character images
 * Part of:       Gandalf Library
 *
 * Revision:      $Revision: 1.14 $
 * Last edited:   $Date: 2004/05/18 17:31:49 $
 * Author:        $Author: pm $
...
#define GAN_IMAGE_PIXEL_MAX_VAL UCHAR_MAX
#define GAN_IMAGE_PIXEL_ZERO_VAL 0
#define GAN_FILL_ARRAY gan_fill_array_uc
#define GAN_COPY_ARRAY gan_copy_array_uc
