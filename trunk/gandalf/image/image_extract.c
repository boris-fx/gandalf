 ...
 * Last edited:   $Date: 2007/03/20 15:09:07 $
 * Author:        $Author: pm $
      ...
      case GAN_UINT16:
        switch ( source->type )
        {
           case GAN_UINT16:
             if ( copy_pixels )
                for ( r=0; r < height; r++ )
                   gan_copy_array_ui32 ((gan_uint32 *)&source->row_data.yuvx444.ui16[r0s+r][c0s], 1, width,
                                        (gan_uint32 *)&dest->row_data.yuvx444.ui16[r0d+r][c0d],1);
             else
             {
                /* make destination image point into source image */
                gan_err_test_ptr ( r0d == 0 && c0d == 0, "extract_yuvx444", GAN_ERROR_INCOMPATIBLE, "" );
      ...
      case GAN_UINT16:
        switch ( source->type )
        {
           case GAN_UINT16:
             if ( copy_pixels )
                for ( r=0; r < height; r++ )
                   gan_copy_array_ui32 ((gan_uint32 *)&source->row_data.yuva444.ui16[r0s+r][c0s], 1, width,
                                        (gan_uint32 *)&dest->row_data.yuva444.ui16[r0d+r][c0d],1);
             else
             {
                /* make destination image point into source image */
                gan_err_test_ptr ( r0d == 0 && c0d == 0, "extract_yuva444", GAN_ERROR_INCOMPATIBLE, "" );
      ...
      case GAN_UINT16:
        switch ( source->type )
        {
           case GAN_UINT16:
             if ( copy_pixels )
                for ( r=0; r < height; r++ )
                   gan_copy_array_ui32 ((gan_uint32 *)&source->row_data.yuv422.ui16[r0s+r][c0s], 1, width,
                                        (gan_uint32 *)&dest->row_data.yuv422.ui16[r0d+r][c0d],1);
             else
             {
                /* make destination image point into source image */
                gan_err_test_ptr ( r0d == 0 && c0d == 0, "extract_yuv422", GAN_ERROR_INCOMPATIBLE, "" );
        ...
        switch ( rgb->type )
        {
           case GAN_UINT16:
           {
              ...
              for ( r=0; r < height; r++ )
                 for ( c=0; c < width; c++ )
                 {
#define CLAMP_0_TO_65535(p) (((p) < 0) ? 0 : (((p) > 65535) ? 65535 : (p)))
                    pixyuv = gan_image_get_pix_yuvx444_ui16(yuvx444,r0s+r,c0s+c);
                    pixi = (11643*(int)pixyuv.Y                       + 15960*(int)pixyuv.V - 256*2242880)/10000;
                    pix.R = (gan_uint16) CLAMP_0_TO_65535(pixi);
                    pixi = (11643*(int)pixyuv.Y -  3917*(int)pixyuv.U -  8130*(int)pixyuv.V + 256*1355960)/10000;
                    pix.G = (gan_uint16) CLAMP_0_TO_65535(pixi);
                    pixi = (11643*(int)pixyuv.Y + 20173*(int)pixyuv.U                       - 256*2784030)/10000;
                    pix.B = (gan_uint16) CLAMP_0_TO_65535(pixi);
                    gan_image_set_pix_rgb_ui16(rgb,r0d+r,c0d+c,&pix);
#undef CLAMP_0_TO_65535
                 }
           }
           break;
   ...
   switch ( rgba->type )
   {
      ...
      case GAN_UINT16:
        switch ( yuva444->type )
        {
           ...
           case GAN_UINT16:
           {
              Gan_YUVA444Pixel_ui16 pixyuv;
   
              for ( r=0; r < height; r++ )
                 for ( c=0; c < width; c++ )
                 {
                    pix = gan_image_get_pix_rgba_ui16(rgba,r0s+r,c0s+c);
                    pixyuv.Y = (gan_uint16) gan_min2_i(( (int)pix.R*2104 + (int)pix.G*4130 + (int)pix.B* 802 + (4096 +  131072)*256) >> 13, 235*256);
                    pixyuv.U = (gan_uint16) gan_min2_i((-(int)pix.R*1214 - (int)pix.G*2384 + (int)pix.B*3598 + (4096 + 1048576)*256) >> 13, 240*256);
                    pixyuv.V = (gan_uint16) gan_min2_i(( (int)pix.R*3598 - (int)pix.G*3013 - (int)pix.B* 585 + (4096 + 1048576)*256) >> 13, 240*256);
                    pixyuv.A = pix.A;
                    gan_image_set_pix_yuva444_ui16(yuva444,r0d+r,c0d+c,&pixyuv);
                 }
           }
           break;
        ...
        switch ( rgba->type )
        {
           case GAN_UINT16:
           {
              ...
              for ( r=0; r < height; r++ )
                 ...
                 {
#define CLAMP_0_TO_65535(p) (((p) < 0) ? 0 : (((p) > 65535) ? 65535 : (p)))
                    pixyuva = gan_image_get_pix_yuva444_ui16(yuva444,r0s+r,c0s+c);
                    pixi = (11643*(int)pixyuva.Y                        + 15960*(int)pixyuva.V - 256*2242880)/10000;
                    pix.R = (gan_uint16) CLAMP_0_TO_65535(pixi);
                    pixi = (11643*(int)pixyuva.Y -  3917*(int)pixyuva.U -  8130*(int)pixyuva.V + 256*1355960)/10000;
                    pix.G = (gan_uint16) CLAMP_0_TO_65535(pixi);
                    pixi = (11643*(int)pixyuva.Y + 20173*(int)pixyuva.U                        - 256*2784030)/10000;
                    pix.B = (gan_uint16) CLAMP_0_TO_65535(pixi);
                    pix.A = pixyuva.A;
                    gan_image_set_pix_rgba_ui16(rgba,r0d+r,c0d+c,&pix);
#undef CLAMP_0_TO_65535
...
#undef CLAMP_0_TO_255
      ...
      case GAN_UINT16:
        switch ( rgb->type )
        {
           case GAN_UINT16:
           {
              Gan_YUV422Pixel_ui16 pixyuv1, pixyuv2;
              int pixi;
              Gan_RGBPixel_ui16 pix1, pix2;
   
              for ( r=0; r < height; r++ )
                 for ( c=0; c < width; c+=2 )
                 {
#define CLAMP_0_TO_65535(p) (((p) < 0) ? 0 : (((p) > 65535) ? 65535 : (p)))
                    pixyuv1 = gan_image_get_pix_yuv422_ui16(yuv422,r0s+r,c0s+c);
                    pixyuv2 = gan_image_get_pix_yuv422_ui16(yuv422,r0s+r,c0s+c+1);
                    pixi = (int)(11643*(int)pixyuv1.Y                    + 15960*pixyuv2.UV  - 256*2242880)/10000;
                    pix1.R = CLAMP_0_TO_65535(pixi);
                    pixi = (int)(11643*(int)pixyuv1.Y -  3917*pixyuv1.UV -  8130*pixyuv2.UV + 256*1355960)/10000;
                    pix1.G = CLAMP_0_TO_65535(pixi);
                    pixi = (int)(11643*(int)pixyuv1.Y + 20173*pixyuv1.UV                     - 256*2784030)/10000;
                    pix1.B = CLAMP_0_TO_65535(pixi);
                    pixi = (int)(11643*(int)pixyuv2.Y                    + 15960*pixyuv2.UV  - 256*2242880)/10000;
                    pix2.R = CLAMP_0_TO_65535(pixi);
                    pixi = (int)(11643*(int)pixyuv2.Y -  3917*pixyuv1.UV -  8130*pixyuv2.UV  + 256*1355960)/10000;
                    pix2.G = CLAMP_0_TO_65535(pixi);
                    pixi = (int)(11643*(int)pixyuv2.Y + 20173*pixyuv1.UV                     - 256*2784030)/10000;
                    pix2.B = CLAMP_0_TO_65535(pixi);
                    gan_image_set_pix_rgb_ui16(rgb,r0d+r,c0d+c,  &pix1);
                    gan_image_set_pix_rgb_ui16(rgb,r0d+r,c0d+c+1,&pix2);
#undef CLAMP_0_TO_65535
                 }
           }
           break;
