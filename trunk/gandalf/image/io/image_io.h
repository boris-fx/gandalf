...
GANDALF_API Gan_ImageFileFormat gan_image_determine_file_format ( const Gan_Char *filename );
...
GANDALF_API Gan_Image *gan_image_read_with_abort_test ( const Gan_Char *filename, Gan_ImageFileFormat file_format, Gan_Image *image,
...
GANDALF_API Gan_Bool gan_image_write ( const Gan_Char *filename, Gan_ImageFileFormat file_format, const Gan_Image *image,
...
GANDALF_API Gan_Image *gan_image_read ( const Gan_Char *filename, Gan_ImageFileFormat file_format, Gan_Image *image,
                                        const Gan_ImageReadControlStruct *ictrlstr, Gan_ImageHeaderStruct *header );
#else
