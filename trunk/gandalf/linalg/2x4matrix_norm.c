/**
 * File:          $RCSfile: 2x4matrix_norm.c,v $
 * Module:        Projective normalisation of 2x4 matrices (double precision)
...
/**
 * \fn Gan_Bool gan_mat24_normalize ( Gan_Matrix24 *B, int n, double term_threshold, int max_iterations, Gan_SquMatrix44 *Lp )
 * \brief Normalize array of 2x4 matrices to identity inertia moment.
 ...
 *
 * This function applies projective normalization to the array of \a n 2x4
 ...
 *
 * \sa gan_vec4_normalize(), gan_mat44_normalize().
 */
