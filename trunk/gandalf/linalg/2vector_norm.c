...
/**
 * \defgroup FixedSizeVectorNormalise Projective Normalisation of Fixed Size Vectors
 * \{
 */

/**
 * \fn Gan_Bool gan_vec2_normalize ( Gan_Vector2 *b, int n, double term_threshold, int max_iterations, Gan_SquMatrix22 *Lp )
