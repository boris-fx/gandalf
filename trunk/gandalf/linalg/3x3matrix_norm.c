/**
 * File:          $RCSfile: 3x3matrix_norm.c,v $
...
/**
 * \fn Gan_Bool gan_mat33_normalize ( Gan_Matrix33 *B, int n, double term_threshold, int max_iterations, Gan_SquMatrix33 *Lp )
 * \brief Normalize array of 3x3 matrices to identity inertia moment.
 ...
 *
 * This function applies projective normalization to the array of \a n 3x3
 ...
 *
 * \sa gan_mat33T_normalize, gan_vec3_normalize(), gan_mat33_normalize().
 */

/**
 * \fn Gan_Bool gan_mat33T_normalize ( Gan_Matrix33 *B, int n, double term_threshold, int max_iterations, Gan_SquMatrix33 *Lp )
 * \brief Normalize array of 3x3 matrices to identity inertia moment.
 * \param B array of matrices to normalise
 * \param n number of vectors in array
 * \param term_threshold termination threshold
 ...
 * 3x3 matrices \a B. After the normalization, the matrices \a B are
 ...
 * \f$ B'_i \f$ as shown above, and #GAN_TRUE is returned.
 *
 * \sa gan_mat33_normalize(), gan_vec3_normalize(), gan_mat33_normalize().
 */
