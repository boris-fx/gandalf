...
Gan_Bool
 gan_strsm ( Gan_LapackSideFlag side, Gan_LapackUpLoFlag uplo,
             Gan_TposeFlag transa, Gan_LapackUnitFlag diag,
             long m, long n, float alpha, float *a,
             long lda, float *b, long ldb )
{
   long i, j, k, nrowa;
   float temp;
