/**
 * File:          $RCSfile: cameraf_cubic_Bspline.c,v $
 ...
 * \sa gan_camera_build_cubic_Bspline().
 */
Gan_Bool
 gan_cameraf_build_cubic_Bspline ( Gan_Camera_f *camera,
                                   float zh,
                                   float fx, float fy,
                                   float x0, float y0,
                                   float skew,
                                   ...
                                   Gan_CubicBSplineSupportF* support )
{
   ...
   if ( !gan_cameraf_set_common_fields ( camera, GAN_CUBIC_BSPLINE_CAMERA, zh, fx, fy, x0, y0 ) )
   {
      gan_err_register ( "gan_cameraf_build_cubic_Bspline", GAN_ERROR_FAILURE, "" );
      return GAN_FALSE;
   }
   ...
   {
      gan_err_register ( "gan_cameraf_build_cubic_Bspline", error_code, "" );
      return GAN_FALSE;
   }
