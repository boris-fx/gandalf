...
GANDALF_API int gan_solve_quadratic ( double a, double b, double c, Gan_Complex x[2] );
GANDALF_API int gan_solve_cubic ( double a, double b, double c, double d, Gan_Complex x[3] );
