 ...
 * Last edited:   $Date: 2007/04/18 15:04:41 $
 * Author:        $Author: pm $
...
GANDALF_API Gan_Mask1D *gan_mask1D_alloc ( Gan_Mask1DFormat format, Gan_Type type, unsigned int size );
#else
 ...
 */
#ifdef GAN_GENERATE_DOCUMENTATION
GANDALF_API Gan_Mask1D *gan_mask1D_alloc_data ( Gan_Mask1DFormat format, Gan_Type type, void *data, unsigned int size );
#else
 ...
 */
#ifdef GAN_GENERATE_DOCUMENTATION
GANDALF_API Gan_Mask1D *gan_mask1D_form ( Gan_Mask1D *mask, Gan_Mask1DFormat format, Gan_Type type, unsigned int size );
#else
