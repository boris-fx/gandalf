/**
 * File:          $RCSfile: camera_equi_solid_angle.c,v $
                 ...
                 int *error_code )
{
   ...
   /* consistency check */
   gan_err_test_bool ( camera->type == GAN_EQUI_SOLID_ANGLE_CAMERA,
                        ...
                        int *error_code )
{
   ...
   /* compute equi-solid angle image coordinates */
...
/**
 * \brief Builds a structure representing a equi-solid angle camera.
 ...
 *
 * Constructs a structure representing a camera, under the equi-solid angle
 ...
 * \sa gan_cameraf_build_equi_solid_angle().
 */
Gan_Bool
 gan_camera_build_equi_solid_angle ( Gan_Camera *camera,
                                     double zh, double fx, double fy,
                                     double x0, double y0 )
{
   if ( !gan_camera_set_common_fields ( camera, GAN_EQUI_SOLID_ANGLE_CAMERA,
                                        zh, fx, fy, x0, y0 ) )
   {
      gan_err_register ( "gan_camera_build_equi_solid_angle",
                         GAN_ERROR_FAILURE, "" );
      return GAN_FALSE;
   }
